...
PROFILES: dict[str, TaskProfile] = {
    "resume_parse": TaskProfile(
        "resume_parse", 0.1, 4000, "resume_parse_v1", "resume_info_v1"
    ),
    ...
    "generic_chat": TaskProfile(
        "generic_chat", 0.2, 2000, "generic_chat_v1", "chat_v1"
    ),
    "advisor_answer": TaskProfile(
        "advisor_answer", 0.2, 2000, "advisor_v1", "advisor_v1"
    ),
    "screening_evidence_summary": TaskProfile(
        "screening_evidence_summary", 0.1, 2000, "screening_v1", "screening_v1"
    ),
    "claim_extract": TaskProfile(
        "claim_extract", 0.1, 2000, "claim_extract_v1", "claim_v1"
    ),
